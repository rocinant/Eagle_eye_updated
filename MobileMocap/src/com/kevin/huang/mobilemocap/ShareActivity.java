...
public class ShareActivity extends Activity {
	...
	public static final String EXTRA_PHOTO_URI = "com.kevin.huang.ShareActivity.extra.PHOTO_URI";
	public static final String EXTRA_PHOTO_DATA_PATH = "com.com.kevin.huang.ShareActivity.extra.PHOTO_DATA_PATH";
	private Uri mUri;
	...
	*/
	private void deletePhoto() {
		final AlertDialog.Builder alert = new AlertDialog.Builder(ShareActivity.this);
		...
		alert.setPositiveButton(R.string.delete, new DialogInterface.OnClickListener() {
			...
			getContentResolver().delete(Images.Media.EXTERNAL_CONTENT_URI, MediaStore.MediaColumns.DATA + "=?", new String[] { mDataPath });
			finish();
			}
		});
